...
class GFv2Embedder(nn.Module):
    ...
    def __init__(self, 
        ...
        self.args.model_name = gf_model_name
        self.args.pretrained_model_name = gf_pretrain_name
        ...
        self.fix_num_pt_layers = fix_num_pt_layers
        self.reinit_num_pt_layers = reinit_num_pt_layers
        self.reinit_layernorm = reinit_layernorm
        if self.pretrain:
    ...
    def forward(
        ...
        batched_node_embeds, _, _ = self.encoder(
            batched_data,
            perturb=perturb,
            return_attn_mats=False,
            return_input_feats=""
