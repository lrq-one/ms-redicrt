...
class ConsoleLogger(Logger):
    ...
    def log_metrics(self, metrics, step):
        ...
        for k, v in metrics.items():
            # Avoid noisy per-step console logs such as train_batch_loss_step.
            # Epoch-level metrics and validation/test metrics are still printed.
            if str(k).endswith("_step"):
                continue
